...
//取出经纬度并且赋值
 latlng = res[0];
    var url = "//map.qq.com/nav/drive?start="+latlng.lng+"%2C"+latlng.lat+"&dest="+navDestination.lng+"%2C"+navDestination.lat+"&sword=我的位置&eword="+navDestination.title+"&ref=mobilemap&referer=";
    // alert(url);
